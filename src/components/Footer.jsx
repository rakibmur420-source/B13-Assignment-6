...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: "#0f172a" }} className="text-white pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
        ...
        <div>
          ...
          <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Social Links</h4>
          <div className="flex gap-3">
            {/* Instagram */}
            <a href="#" className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center hover:border-gray-400 transition-colors">
      ...
      {/* Bottom bar */}
      <div className="max-w-7xl mx-auto border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
